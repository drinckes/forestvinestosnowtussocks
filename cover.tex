...
\setlength{\authoroffset}{\coverwidth+\covertrimsize+\coverspinewidth+0.1\coverwidth}%

\newlength{\titlewidth}
\setlength{\titlewidth}{0.8\coverwidth}
...
\begin{document}
	...
	\begin{textblock*}{0.8\coverwidth} (\authoroffset, 50mm) % {block width} (coords)
