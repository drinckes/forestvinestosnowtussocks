...
\newlength{\titleoffset}
\setlength{\titleoffset}{\facewidth+\trimsize+\spinewidth+0.1\facewidth}%

% Horizontal offset to the back cover text box.
\newlength{\blurbwidth}
\setlength{\blurbwidth}{0.66\facewidth}
\newlength{\blurboffset}
\setlength{\blurboffset}{\trimsize+0.5\facewidth-0.5\blurbwidth}
...
\usepackage{geometry}
\geometry{
	papersize={\stockwidth,\stockheight},
	outer=0cm,
	inner=0cm,
	top=0cm,
	bottom=0cm,
...
\begin{document}
	...
	\begin{textblock*}{0.8\facewidth} (\titleoffset, 50mm) % {block width} (coords)
