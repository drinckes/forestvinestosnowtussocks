...
\begin{figure}[!t]
	...
	\begin{minipage}[t]{0.95\textwidth}
		\begin{minipage}[t]{(\textwidth-\fgap) * \real{0.703}}
			\centering
			\includegraphics[width=\textwidth]{graphics/fig_074}
		...
		\begin{minipage}[t]{(\textwidth-\fgap) * \real{0.297}}
			\centering
			\includegraphics[width=\textwidth]{graphics/fig_075}
	...
	% Inner minipages scaled so the images have the same height.
	\begin{minipage}[t]{0.95\textwidth}
		\begin{minipage}[t]{(\textwidth-\fgap) * \real{0.351}}
			\centering
			\includegraphics[width=\textwidth]{graphics/fig_076}
		...
		\end{minipage}\hspace{\fgap}%
		\begin{minipage}[t]{(\textwidth-\fgap) * \real{0.649}}
			\centering
			\includegraphics[width=\textwidth]{graphics/fig_077}
...
\begin{SCfigure}[2.0][!b]
	\includegraphics[width=0.5\textwidth]{graphics/fig_078}
	\centering
...
\begin{SCfigure}[1.0][!b]
	\includegraphics[width=0.66\textwidth]{graphics/fig_080}
	\centering
...
\begin{figure}[!t]
	\centering
	\includegraphics[width=0.75\textwidth]{graphics/fig_079}
