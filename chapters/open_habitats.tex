...
\begin{SCfigure}[2.0][!t]
	...
	\centering
		\caption[Short tussock grassland dominated by fescue-tussock]{Short tussock grassland dominated by \IDX{fescue tussock} (\BotanicRef{Festuca novae-zelandiae}[Festuca][novae-zelandiae]) on the Mt.
