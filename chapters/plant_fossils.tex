...
\begin{SCfigure}[2.0][!b]
	...
	\centering
	\caption[Pollen of \emph{Zygogynum baillonii} of New Caledonia]{Pollen of \BotanicRef{Zygogynum baillonii}[Zygogynum][baillonii] of \IDX{New Caledonia}.
	\BotanicRef{Zygogynum} belongs to the primitive family Winteraceae and at the present day is restricted to \IDX{New Caledonia}.
...
South of there Myrtaceae, \IDX{rimu} (\BotanicRef{Dacrydium cupressinum}[Dacrydium][cupressinum]), \IDX{red beech}[beech!red] (\BotanicRef{Nothofagus fusca}[Nothofagus][fusca]) group and ferns were common.
