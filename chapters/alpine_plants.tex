...
\begin{SCfigure}[2.0][t]
	...
	The herb with very divided leaves is \IDX{Haasts carros} (\BotanicRef{Anisotome haastii}[Anisotome][haastii]) and the long silvery leaves at the top belong to the \IDX{mountain astelia} (\BotanicRef{Astelia nervosa}[Astelia][nervosa]).
