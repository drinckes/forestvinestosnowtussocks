...
\IDX{Swamp maire}[maire!swamp] (\BotanicRef{Syzygium maire}[Syzygium][maire], \IDX{maire tawake}, \IDX{waiwaka}) is often associated with \IDX{pukatea} in swamp forests and it too forms specialised pneumatophores.
...
\begin{SCfigure}[0.5][t]
	...
	\centering
	\caption[Roots of swamp maire]{Roots of \IDX{swamp maire}[maire!swamp] (\BotanicRef{Syzygium maire}[Syzygium][maire], \IDX{maire tawake}, \IDX{waiwaka}).
...
In the species of \BotanicRef{Myrsine}, \BotanicRef{Melicytus}\figureref{\fullref{fig:17mahoe}} the liane \IDX{white rata}[rata!white] (\BotanicRef{Metrosideros diffusa}[Metrosideros][diffusa]) and \IDX{Parkinson's rata}[rata!Parkinson's] (\BotanicRef{Metrosideros parkinsonii}[Metrosideros][parkinsonii]), the flowers arise on woody twigs towards the tips of branches, a less extreme condition often known as ramiflory.
