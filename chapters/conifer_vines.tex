...
\IDX{White flowering rata}[white flowering rata] (\BotanicRef{Metrosideros albiflora}[Metrosideros][albiflora], \IDX{akatea}) and \IDX{carmine rata} (\BotanicRef{Metrosideros carminea}[Metrosideros][carminea]) are restricted to the northern North Island. \BotanicRef{Metrosideros albiflora}[Metrosideros][albiflora] is most common in kauri forests.
