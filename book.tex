...
% \begin{figure}[htb]
% 	\includegraphics[width=0.9\textwidth]{graphics/figure1vegetation-patterns.jpg}
% 	\centering
...
Other trees may also have buttresses: e.g. kohekohe (\itindex{Dysoxylum spectabile}), kahikatea (\itindex{Dacrycarpus dacrydioides}), and some species of beech (\itindex{Nothofagus}), but these are usually not plank-like.
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[Juvenile and adult leaves of Pseudopanax simplex var. simplex]{Juvenile and adult leaves of \itindex{Pseudopanax simplex var. simplex}.
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[Leaves of the climbing fern Blechnum filiforme]{Leaves of the climbing fern \itindex{Blechnum filiforme}.
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[Leaves of the climbing fern Arthropteris tenella]{Leaves of the climbing fern \itindex{Arthropteris tenella}.
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[Phymatosorus scandens growing up a tree trunk]{\itindex{Phymatosorus scandens} growing up a tree trunk.
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[Rubus squarrosus]{\itindex{Rubus squarrosus}.
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[Pyrrosia serpens, a fern mat epiphyte]{\itindex{Pyrrosia serpens}, a fern mat epiphyte.
    Photo  J. W. Dawson.}
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[Epiphytic plant of the fern Asplenium jlaccidum]{Epiphytic plant of the fern \itindex{Asplenium jlaccidum}.
	Photo: M. D. King.}
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[The small epiphytic shrub Brachyglottis kirkii]{The small epiphytic shrub \itindex{Brachyglottis kirkii} growing from an asteliad nest.
	Photo: B. V. Sneddon.}
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[Dicksonia fibrosa tree ferns with thick `skirts' of dead fronds and stout trunks]{\itindex{Dicksonia fibrosa} tree ferns with thick `skirts' of dead fronds and stout trunks, most of whose bulk is made up by interwoven wiry roots.
Inland Taranaki.
	Photo: J. W. Dawson.}
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[The root parasite Dactylanthus taylori]{The root parasite \itindex{Dactylanthus taylori}.
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[Tangled thread-like stems of the leafless parasite Cassytha pubescens]{Tangled thread-like stems of the leafless parasite \itindex{Cassytha pubescens} on manuka (\itindex{Leptospermum scoparium}).
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[Habit of Pittosporum obcordatum]{Habit of \itindex{Pittosporum obcordatum} in cultivation at Otari Gardens, Wellington.
	Photo: J. W. Dawson.}
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[Pseudopanax anomalus]{\itindex{Pseudopanax anomalus}.
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[Short tussock grassland mostly of Festuca novae-zelandiae]{Short tussock grassland mostly of \itindex{Festuca novae-zelandiae} on hills north of the upper Waitaki River.
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[Aciphylla subflabellata with male inflorescencs]{\itindex{Aciphylla subflabellata} with male inflorescences.
    Photo:  J. W. Dawson.}
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[Aciphylla subflabellata seedhead]{\itindex{Aciphylla subflabellata} seedhead with most of the bract segments aligned vertically to form a cage around the seeds.
    Photo:  J. W. Dawson.}
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[A group of unbranched shrubs of Dracophyllum fiordense]{A group of unbranched shrubs of \itindex{Dracophyllum fiordense} together with needle-leaved Dracophyllums and other shrubs.
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[Hebe tetragon]{\itindex{Hebe tetragona}.
    A `whipcord' Hebe.
	Photo: M. D. King.}
	\label{fig:93hebe}
\end{SCfigure}
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[Gaultheria depressa]{\itindex{Gaultheria depressa}.
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[Flowers of Ranunculus lyallii]{Flowers of \itindex{Ranunculus lyallii} at Arthurs Pass, Canterbury.
	Photo: J. W. Dawson.}
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[Gentiana bellidifolia]{\itindex{Gentiana bellidifolia}.
    Mt. Peel,  N. W. Nelson.
	Photo: J. W. Dawson.}
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[Astelia nervosa in snow tussock]{\itindex{Astelia nervosa} in snow tussock (\itindex{Chionochloa pollens}) grassland.
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[Donatio novae-zelandiae]{A dense cushion of \itindex{Donatio novae-zelandiae} with numerous flowers.
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[Hebe epacridea]{\itindex{Hebe epacridea}.
	Photo: M. D. King.}
	\label{fig:106hebe}
\end{SCfigure}
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[Close view of a portion of a Haastia pulvinaris]{Close view of a portion of a \itindex{Haastia pulvinaris} cushion showing the branchlet tips closely invested by woolly leaves.
	Photo: J. W. Dawson.}
...
Of \itindex{Dracophyllum arboreum} Wright\footnote{\cite{wright1959soils}} says: `In many respects a parallel can be drawn between the kauri tree (\itindex{Agathis australis}) of Northland … and \itindex{Dracophyllum arboreum} in the Chathams.
...
The litter in the case of each species consists of leaf, twig and bark residues of high resinous composition.' The tree ferns \itindex{Dicksonia squarrosa} and \itindex{D. fibrosa} are prominent in the understory and filmy ferns on the forest floor and, as epiphytes, are a prominent feature.
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[Fossil leaf compression]{Fossil leaf compression about 7x4 cm, of the extinct \itindex{Nothofagus oliveri}, from Nuggety creek, near Murchison.
    Mid-Miocene age.
	Photo: J. E. Casey.}
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[Pollen of Zygoynum baillonii of New Caledonia]{Pollen of \itindex{Zygoynum baillonii} of New Caledonia. \itindex{Zygogynum} belongs to the primitive family Winteraceae and at the present day is restricted to New Caledonia.
...
\itindex{Forest Vines to Snow Tussocks} fills an important gap in New Zealand's botanical literature — a fascinating and invaluable book for student and general reader alike.
