...
Two other conifers with scale-leaved adults are our only \BotanicRef{Dacrydium} --- rimu (\BotanicRef{Dacrydium cupressinum}[Dacrydium][cupressinum]) and kahikatea (\BotanicRef{Dacrycarpus dacrydioides}[Dacrycarpus][dacrydioides])\figureref{\fullref{fig:21rimu}, \fullref{fig:22kahikatea}}.
...
\begin{figure}[htb]
	...
	\begin{minipage}[t]{0.502\textwidth}
		\centering
		\includegraphics[width=0.9\textwidth]{graphics/figure32kiekie.jpg}
	...
	\begin{minipage}[t]{0.478\textwidth}
    	\centering
    	\includegraphics[width=0.9\textwidth]{graphics/figure33supplejack.jpg}
...
\begin{figure}[htb]
	...
	\begin{minipage}[t]{0.413\textwidth}
    	...
    	\caption[Puka (\emph{Griselinia lucida}) showing girdling roots]{Puka (\BotanicRef{Griselinia lucida}[Griselinia][lucida]) showing girdling roots.
    	Waikanae, southern North Island.
    	Photo: M. D. King.}%
...
Five-finger (\BotanicRef{Pseudopanax arboreus}[Pseudopanax][arboreus]) is common as a terrestrial plant in shrubby forest regrowth, but in more mature forest it can be surprisingly frequent as a tree fern epiphyte, mostly on the ponga\figureref{\fullref{fig:55fivefinger}}, but also on wheki.
