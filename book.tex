...
Do floras which have evolved on isolated islands which have never been connected to a continent have any characteristics to distinguish them from continental floras? Studies of both the flora and fauna of \IDX{Hawai{\okina}i},\footnote{\cite{carlquist1970hawaii}} as well as of other isolated islands,\footnote{\cite{carlquist1965island}} suggest that the answer to this question is `yes'
...
Thus it has been estimated that 272 immigrant species could have evolved into the present approximately 1200 native higher plant species of \IDX{Hawai{\okina}i}.
...
Thus on mountainous islands like \IDX{Hawai{\okina}i}, some species of a genus may be small and herbaceous and occupy coastal and lowland open habitats, other species may be small trees in wet forests at various altitudes, and yet others shrubs or herbs in alpine vegetation.
...
In \IDX{Hawai{\okina}i} it is estimated that 27.5 per cent of the species are dioecious,\footnote{\cite{carlquist1970hawaii}} a much higher proportion than for the United Kingdom, for example, where it is estimated only 2 per cent of species are in this category.
...
On islands like \IDX{Hawai{\okina}i} an unusually high proportion of the native plants have small, shallow flowers which lack bright colours and are pollinated by wind or unspecialised short tongued insects.
...
\begin{description}
\item[{(a)}]Conifers are a prominent feature of the forests with the giant kauri (\BotanicRef{Agathis australis}[Agathis][australis]) in the far north and the more widespread species of the family Podocarpaceae (`Podocarps') including rimu (\BotanicRef{Dacrydium cupressinum}[Dacrydium][cupressinum]), \IDX{kahikatea} (\BotanicRef{Dacrycarpus dacrydioides}[Dacrycarpus][dacrydioides]) and \IDX{totara} (\BotanicRef{Podocarpus totara}[Podocarpus][totara]).
...
\item[{(c)}]The woody families of the order Ranales are represented in New Zealand by several species, including horopito (\BotanicRef{Pseudowintera} species), \IDX{tawa} (\BotanicRef{Beilschmiedia tawa}[Beilschmiedia][tawa]) and pukatea (\BotanicRef{Laurelia novae-zelandiae}[Laurelia][novae-zelandiae]).
\end{description}
...
\end{SCfigure}
\item[{(b)}]The level of dioecism in the New Zealand flora\figureref{\fullref{fig:4kaikomako}} is, at 12 per cent,\footnote{\cite{godley1979flower}} much lower than that of \IDX{Hawai{\okina}i}, but still much higher than that of Europe.
...
\item[{(d)}]With the exceptions of the brightly coloured, bird-pollinated flowers such as the \IDX{rata}s (\BotanicRef{Metrosideros}) and kowhais (\BotanicRef{Sophora}), New Zealand plants on the main islands, like those of \IDX{Hawai{\okina}i}, are not notable for size or colour of flowers.
...
Other trees may also have buttresses: \eg\ kohekohe (\BotanicRef{Dysoxylum spectabile}[Dysoxylum][spectabile]), \IDX{kahikatea} (\BotanicRef{Dacrycarpus dacrydioides}[Dacrycarpus][dacrydioides]), and some species of beech (\BotanicRef{Nothofagus}), but these are usually not plank-like.
...
In \IDX{towai} (\BotanicRef{Weinmannia silvicola}[Weinmannia][silvicola]) the trend is from five to one pairs of leaflets; in kamahi (\BotanicRef{Weinmannia racemosa}[Weinmannia][racemosa]) from one or two pairs of leaflets to simple leaves\figureref{\fullref{fig:19leaves}}.
...
Two other conifers with scale-leaved adults are our only \BotanicRef{Dacrydium} --- rimu (\BotanicRef{Dacrydium cupressinum}[Dacrydium][cupressinum]) and \IDX{kahikatea} (\BotanicRef{Dacrycarpus dacrydioides}[Dacrycarpus][dacrydioides])\figureref{\fullref{fig:21rimu}, \fullref{fig:22kahikatea}}.
...
\begin{figure}[htb]
	...
	\begin{minipage}[t]{0.502\textwidth}
    	...
    	\caption[The drooping stems and foliage of kiekie]{The drooping stems and foliage of kiekie (\BotanicRef{Freycinetia baueriana var.\ banksii}[Freycinetia][baueriana var.\ banksii]) completely obscuring a \IDX{kahikatea} trunk. Kaitoke, near Wellington, southern North Island. Photo: J. W. Dawson.}%
    	\label{fig:32kiekie}
	\end{minipage}\hfill%
...
The intrepid Harrison-Smith\footnote{\cite{harrisonsmith1938kauri}} found a \SI{3}{\metre} kauri growing on a kauri, as well as several examples of other conifers --- rimu, \IDX{totara}, \IDX{kahikatea} and several angiosperm trees.
...
\begin{figure}[htb]
	...
	\begin{minipage}[t]{0.493\textwidth}
    	...
    	\caption[The large shrub epiphyte puka]{The large shrub epiphyte puka (\BotanicRef{Griselinia lucida}[Griselinia][lucida]) on a \IDX{kahikatea}.
...
\begin{figure}[htb]
	...
	\begin{minipage}[t]{0.494\textwidth}
    	...
    	\caption[Roots of puka on tawa]{Roots of puka (\BotanicRef{Griselinia lucida}[Griselinia][lucida]) on \IDX{tawa} (\BotanicRef{Beilschmiedia tawa}[Beilschmiedia][tawa]).
...
\begin{figure}[htb]
	...
	\begin{minipage}[t]{0.567\textwidth}
    	...
    	\caption[Mountain five-finger on a kahikatea]{Mountain five-finger (\BotanicRef{Pseudopanax colensoi}[Pseudopanax][colensoi]) on a \IDX{kahikatea}.
...
Similar \BotanicRef{Metrosideros} epiphytes are known in New Caledonia, Fiji and \IDX{Hawai{\okina}i}.
...
It is thus comparable with the girdling roots of the puka and \IDX{northern rata}[rata!northern].
...
As has already been mentioned, epiphytes sometimes grow on the ground and in some circumstances may be important components of terrestrial communities For example on Rangitoto Island, a volcanic cone only a few centuries old in Auckland Harbour, the epiphytes \IDX{northern rata}[rata!northern] (\BotanicRef{Metrosideros robusta}[Metrosideros][robusta]), puka (\BotanicRef{Griselinia lucida}[Griselinia][lucida])\BotanicRef{Brachyglottis kirkii}[Brachyglottis][kirkii] (Senecio),  \BotanicRef{Astelia solandri}[Astelia][solandri] and \BotanicRef{Collospermum hastatum}[Collospermum][hastatum] are common on dry sunny mounds of scoria.
Pohutukawa (\BotanicRef{Metrosideros excelsa}[Metrosideros][excelsa]) is also present and it hybridises freely with \IDX{northern rata}[rata!northern].
...
Miro occupies a similar range of sites to rimu, and \IDX{matai} is most abundant on fertile alluvial or volcanic ash soils.
...
Some flowering trees also contribute to this stratum: \IDX{northern rata}[rata!northern] (\BotanicRef{Metrosideros robusta}[Metrosideros][robusta]) because it commences its life on a rimu or other tall tree; pukatea (\BotanicRef{Laurelia novae-zelandiae}[Laurelia][novae-zelandiae]) in association with \IDX{kahikatea} in moist places; and \IDX{rewa rewa} (\BotanicRef{Knightia excelsa}[Knightia][excelsa]).
...
Of the three flowering trees \IDX{rewa rewa} and \IDX{northern rata}[rata!northern] reach their southern limits in the northern South Island, while pukatea extends to Fiordland on the west.

\subsection{Canopy}

North of \ang{36}S on the Northland Peninsula, \IDX{taraire} (\BotanicRef{Beilschmiedia tarairi}[Beilschmiedia][tarairi]), with its broad mesophyll leaves, dominates the canopy, usually in association with kamahi's northern relative \IDX{towai} (\BotanicRef{Weinmannia silvicola}[Weinmannia][silvicola]).
...
Succeeding \IDX{tawa} altitudinally as the canopy dominant in the North Island from about \ang{39}S is kamahi (\BotanicRef{Weinmannia racemosa}[Weinmannia][racemosa]); it also replaces \IDX{tawa} in the lowland conifer broadleaf forests of most of the South Island and Stewart Island.
...
On the west and south of the South Island \IDX{southern rata}[rata!southern] (\BotanicRef{Metrosideros umbellata}[Metrosideros][umbellata]) contributes to the canopy of kamahi forests.
...
For example, on the volcanic plateau of the central North Island it has been observed in forests with emergent podocarps over a main canopy of kamahi, or kamahi and \IDX{tawa}, that where a podocarp falls the gap is occupied by tree ferns.
...
\begin{SCfigure}[1.0][htb]
	...
	The narrow-leaved shrubs are \IDX{neinei} (\BotanicRef{Dracophyllum latifolium}[Dracophyllum][latifolium]), and the narrowleaved ground herbs kauri grass (\BotanicRef{Astelia trinervia}[Astelia][trinervia]).
...
Most of the tree species of the non-kauri forests are present however, including rimu, \IDX{taraire}, \IDX{tawa}, \IDX{towai} and \IDX{northern rata}[rata!northern], but they tend to be rather small-crowned and spindly.
...
Whatever the cause, the lack of regeneration shows that kauris are unable to replace themselves in closed forests, and Cockayne postulated that the climax forest would be one without kauris in which the dominance would probably be assumed by \IDX{taraire}.
...
In the North Island, and northern parts of the South Island, pukatea (\BotanicRef{Laurelia novae-zelandiae}[Laurelia][novae-zelandiae]) is a common associate of \IDX{kahikatea} and in this type of forest often has well-developed plank buttresses which extend into roots raised above the forest floor with shield-like pneumatophores here and there.
...
The species represented suggest that \IDX{kahikatea} (\BotanicRef{Dacrycarpus dacrydioides}[Dacrycarpus][dacrydioides])-dominated forest occupied moister and swampy sites, rimu (\BotanicRef{Dacrydium} cupressinum)-dominated forest drier sites and silver beech (\BotanicRef{Nothofagus menziesii}[Nothofagus][menziesii]) forest the higher altitudes.
...
Deer have also been a problem in the forests, as has the introduced Australian opossum, which may entirely defoliate some palatable species such as \IDX{northern rata}[rata!northern] (\BotanicRef{Metrosideros robusta}[Metrosideros][robusta]) and five-finger (\BotanicRef{Pseudopanax arboreus}[Pseudopanax][arboreus]).
...
So if species of this element were already present in New Zealand before colder climates and mountains developed, where did they grow? Wardle points out that even today a number of the species of the group occur in the wet Westland climate within \SI{300}{\metre} of sea level on infertile soils, and in \IDX{Hawai{\okina}i}, whose climate may be similar to that of New Zealand during the Tertiary, otherwise alpine species can be found in a bog at only \SI{600}{\metre} altitude.
...
There are no conifers at all, no beeches (\BotanicRef{Nothofagus}), nor any of the other canopy dominants such as \IDX{tawa} (\BotanicRef{Beilschmiedia tawa}[Beilschmiedia][tawa]), kamahi (\BotanicRef{Weinmannia racemosa}[Weinmannia][racemosa]), hinau (\BotanicRef{Elaeocarpus dentatus}[Elaeocarpus][dentatus]), or northern or \IDX{southern rata}[rata!southern] (\BotanicRef{Metrosideros robusta}[Metrosideros][robusta], \BotanicRef{Metrosideros umbellata}[Metrosideros][umbellata]).
...
The islands in the group are mostly larger than Tahiti and the largest and southernmost, \IDX{Hawai{\okina}i} itself, has dome-like volcanoes, some still active, rising to over 4000 m.
...
Species and varieties of \BotanicRef{Metrosideros} dominate in most Hawaiian forests, particularly on the island of \IDX{Hawai{\okina}i} where some forms colonise lava flows and may form trees up to \SI{30}{\metre} in height.
...
The Lobelia family has undergone remarkable development in \IDX{Hawai{\okina}i} with several genera and many species of shrubs and small trees, some of which are found in moist forests.
...
Above tree limit on the high volcanoes of \IDX{Hawai{\okina}i} and Maui there is low shrubby vegetation on well drained sites reminiscent of the mountain shrubland of the volcanic Mt.
...
Some trees and shrubs appeared to be better represented in the lake sediments than in the surrounding forest --- \IDX{matai} (\BotanicRef{Prumnopitys taxifolia}[Prumnopitys][taxifolia]), \IDX{Hall's totara}[totara!Hall's] (\BotanicRef{Podocarpus hallii}[Podocarpus][hallii]), \BotanicRef{Phyllocladus aspleniifolius}[Phyllocladus][aspleniifolius], manuka (\BotanicRef{Leptospermum scoparium}[Leptospermum][scoparium]), kanuka (\BotanicRef{Kunzea ericoides}[Kunzea][ericoides]), \IDX{southern rata}[rata!southern] (\BotanicRef{Metrosideros umbellata}[Metrosideros][umbellata]) and \BotanicRef{Coprosma propinqua}[Coprosma][propinqua].
