...
Of our three species of \itindex{Fuchsia} one (\itindex{Fuchsia excorticata}) is a small tree, one is a scrambling climber (\itindex{Fuchsia perscandens}) and the last (\itindex{Fuchsia procumbens}) is a prostrate, spreading near-herb.
...
In the species of \itindex{Myrsine}, \itindex{Melicytus}\figureref{\fullref{fig:17mahoe}} the liane \itindex{Metrosideros diffusa} and \itindex{Metrosideros parkinsonii}, the flowers arise on woody twigs towards the tips of branches, a less extreme condition often known as ramiflory.
...
One variety of \itindex{Pseudopanax simplex} has juvenile leaves very similar to those of \itindex{PPseudopanax edgerleyii} and simple, toothed adult leaves\figureref{\fullref{fig:18pseudopanax}}.
...
In towai (\itindex{Weinmannia silvicola}) the trend is from five to one pairs of leaflets; in kamahi (\itindex{Weinmannia racemosa}) from one or two pairs of leaflets to simple leaves\figureref{\fullref{fig:19leaves}}.
...
The related but less common \itindex{Pseudopanax ferox} is very similar, but the juvenile leaves have very coarse irregularly-shaped teeth\figureref{\fullref{fig:19leaves}}.
...
In the case of two species, black maire (\itindex{Nestegis cunninghamii}) and white maire (\itindex{Nestegis lanceolata}), the juveniles are much narrower than the adults, but as they are also often longer they may have about the same area as the adult leaves or somewhat less.
The last species, \itindex{Nestegis montana}, has adult and juvenile leaves which are almost equally narrow, but the juveniles, being longer, are greater in area than the adults.
...
As the name of this species indicates, it has a range of leaf forms similar to \itindex{Phymatosorus scandens}.\footnote{Synomyms \itindex{Dendroconche scandens}, \itindex{Microsorum scandens}.}
...
A third species of \itindex{Phymatosorus} --- \itindex{Phymatosorus novae-zelandiae} --- is found in montane forests throughout the North Island, but is absent from the South Island.
With its stout rhizomes it is similar to \itindex{Phymatosorus diversifolius}, but the rhizomes are densely covered with straw-coloured scales and the leaves are generally larger with more numerous, narrower and longer lateral segments.
...
\itindex{Phymatosorus scandens}: Australia, Norfolk Island.
...
\itindex{Metrosideros albiflora} and \itindex{Metrosideros carminea} are restricted to the northern North Island. \itindex{Metrosideros albiflora} is most common in kauri forests.
It has the largest leaves of the group and small, white flowers. \itindex{Metrosideros carminea} is much rnore colourful, with masses of large, crimson flowers, and it is now popular as a garden plant. \itindex{Metrosideros perforata}, \itindex{Metrosideros fulgens} and \itindex{Metrosideros diffusa} frequently occur together as far as the northern South Island and \itindex{Metrosideros diffusa} continues alone to Stewart Island. \itindex{Metrosideros diffusa} often forms slender stems near the ground which spread widely in the humus of the forest floor and climb any trunks they encounter. \itindex{Metrosideros colensoi} also reaches the northern South Island, but is more localised in its occurrence, favouring forests on fertile soils such as those of river terraces.
The strongly weeping habit of its foliage is a distinctive feature. \itindex{Metrosideros fulgens} has large flowers ranging in colour from orange to dark red, while the other species have small white to pinkish flowers.
Most of the climbing ratas flower from early to mid-summer, but \itindex{Metrosideros carminea} flowers in early spring and \itindex{Metrosideros fulgens} is remarkable both for the timing and length of its flowering season --- the first flowers may appear in late summer and flowering continues through the winter into early spring.
...
\itindex{Parsonsia capsularis} has small flowers, different in form from those of \itindex{Parsonsia heterophylla}, but the adult leaves of some varieties of the two species are very similar. \itindex{Parsonsia capsularis} also has long, narrow, reddish-brown juvenile leaves, and in some cases these are retained at the adult flowering stage.
This is a smaller plant than its more common relative and grows in shrub communities and, less often, at forest margins.
The small, fragrant flowers of these two species are borne in clusters and are white, yellow or, in the case of \itindex{Parsonsia capsularis} only, red.
...
Two species of \itindex{Muehlenbeckia} are twining lianes common throughout New Zealand in lowland to montane forests. \itindex{Muehlenbeckia australis} is the larger species and its seedlings are often abundant on the forest floor in both shady and well-lit places, but mature plants are most commonly found at forest margins or in regenerating forest.
...
A distinctive feature of \itindex{Muehlenbeckia australis} is its formation of firm cane-like `searcher shoots' during the autumn from any part of the stem system.
...
\itindex{Muehlenbeckia complexa} is similar in its growth habit to \itindex{Muehlenbeckia australis}, but it is smaller in all respects and grows on shrubs or small trees at forest margins or in shrub associations.
The leaves are only about 1 cm long, more or less circular and a little thicker than those of \itindex{Muehlenbeckia australis}.
The New Zealand species of the genus are largely endemic although \itindex{Muehlenbeckia australis} occurs on Norfolk Island.
...
The four or five other climbing New Zealand species of \itindex{Clematis} are smaller than \itindex{Clematis paniculata}.
They are incompletely known and in some cases not yet clearly defined.
Several grow at forest margins, including \itindex{Clematis forsteri} and \itindex{Clematis foetida}, and some also grow in shrubland.
...
This species is similar in eventual height and stem size to \itindex{Rubus australis}.
...
One of our species of \itindex{Lycopodium}, the attractive trailing \itindex{Lycopodium volubile}, can also be a scrambling climber over shrubs.
...
Several of the climbing ratas (\itindex{Metrosideros}) can also be encountered as shrubs. \itindex{Metrosideros perforata} in particular has a dense, billowy form, which gives no hint of any ability to climb.
...
Of the ferns, three are species of \itindex{Grammitis} characterised by tufts of narrow simple leaves arising from short rhizomes. \itindex{Grammitis pseudociliata} differs from \itindex{Grammitis billardieri} and \itindex{Grammitis magellanica subspecies nothofageti} in having an abundance of reddish hairs on its leaves. \itindex{Grammitis pseudociliata} is concentrated in the North Island; \itindex{Grammitis billardieri} and \itindex{Grammitis magellanica} extend throughout the country, the last also occurring in south-east Australia.
...
As epiphytes, they grow mostly near the coast in the northern half of the North Island. \itindex{Peperomia tetraphylla} ranges from the East Cape district through to the Bay of Plenty.
It has leaves in whorls of four as its name indicates.
The same species is also found in Australia and Polynesia, \itindex{Peperomia urvilleana} bears its leaves singly and grows throughout the North Island and near the northern shores of the South Island, but is less common in the southern part of its range and there grows mostly on rocks.
...
The stalk bearing the small flower or flowers arises from below the pseudobulb. \itindex{Bulbophyllum pygmaeum} is the smaller species with leaves about a centimetre long but it forms larger patches than those of \itindex{Bulbophyllum tuberculatum}.
The leaves of \itindex{Bulbophyllum tuberculatum} are several times longer, but this species is less frequently seen and is not known further south than the north coast of the South Island.
...
In New Zealand there are three long and narrow-leaved species belonging to two closely related genera of the lily family --- \itindex{Collospermum hastatum}, \itindex{Collospermum microspermum} and \itindex{Astelia solandri}.
...
\itindex{Collospermum hastatum} accompanies \itindex{Astelia solandri} through the North Island and to about 42° 30' in the South Island. \itindex{Collospermum microspermum} is restricted to the North Island and replaces \itindex{Collospermum hastatum} in montane forests above about 300 m. \itindex{Collospermum hastatum} has fan-like arrangements of black-based leaves\figureref{\fullref{fig:41collospermum}} which are somewhat shorter and much broader than those of \itindex{Astelia solandri}.
...
The water stored by \itindex{Collospermum hastatum} is partly absorbed by roots which grow into the tanks, but the suggestion that it is also absorbed through the embedded multicellular bases of overlapping scales has not been confirmed.
...
The ferns \itindex{Asplenium polyodon} (= \itindex{Asplenium falcatum}) and \itindex{Asplenium flaccidum} may have leaves of a metre or more in length below the epiphyte nests. \itindex{Asplenium polyodon}, with its double-toothed, wedge-shaped leaflets is perhaps the most attractive of the New Zealand species of the genus\figureref{\fullref{fig:40asteliad}}. \itindex{Asplenium flaccidum} has an unusual stringlike appearance with long and narrow, deeply-toothed leaflets\figureref{\fullref{fig:43asplenium-jlaccidum}}.
Dobbie aptly describes the leaves of this species as appearing to have been `cut from a piece of pale-green leather'. \itindex{Asplenium polyodon} is found from India to Australia and the Pacific and \itindex{Asplenium flaccidum} in Australia and some Pacific Islands.
...
The leaves are formed in two rows, more or less in one plane; those of \itindex{Epidendrum mucronata} are narrow, thin and quite grasslike while those of \itindex{Epidendrum autumnalis} are broader and thicker, in keeping with the more robust nature of the plant as a whole.
Both species form terminal sprays of small flowers, \itindex{Epidendrum mucronata} in the spring and \itindex{Epidendrum autumnalis} in the autumn.
The flower clusters of \itindex{Epidendrum mucronata} hang down and are yellowish orange, those of \itindex{Epidendrum autumnalis} turn upwards and are waxy white with a strong spicy perfume.

Our sole species of the large tropical genus \itindex{Dendrobium} (\itindex{Dendrobium cunninghamii}) is the largest of New Zealand's epiphytic orchids.
...
The two species of \itindex{Pittosporum} and one each of \itindex{Senecio} and \itindex{Coprosma} in this category are not usually more than a metre high when growing as epiphytes, but may attain small tree size on the ground.
...
The capsule is apparently not so colourful as that of \itindex{Pittosporum cornifolium}, but is described as having an orange lining.
...
Recently a distinctive new tree species of \itindex{Metrosideros} (\itindex{Metrosideros bartlettii}) has been described.\footnote{\cite{dawson1985metrosideros}}
...
The related gully tree fern (\itindex{Cyathea cunninghamii}) has similar trunk characteristics.
...
In \itindex{Dicksonia flbrosa}\figureref{\fullref{fig:54dicksonia-fibrosa}}, \itindex{Cyathea smithii} and young plants of \itindex{Cyathea medullaris} and \itindex{Cyathea cunninghamii},  epiphytes are discouraged in the upper part of the trunk by the persistence of the old leaves as a `skirt'.\footnote{\cite{page1986tree}}
...
Some treat this lycopodium as a distinct species, \itindex{Lycopodium novae-zelandicum}; others regard it as a form of \itindex{Lycopodium varium}.

\itindex{Asplenium flaccidum}, common on trees, also inhabits tree fern trunks.
The filmy ferns \itindex{Hymenophyllum lyallii}, \itindex{Hymenophyllum ferrugineum} and \itindex{Trichomanes venosum} are almost confined to tree fern trunks and others are frequently present.
Several species of \itindex{Tmesipteris} remain largely restricted to such sites --- \itindex{Tmesipteris elongata subspecies elongata} throughout and \itindex{Tmesipteris lanceolata} and \itindex{Tmesipteris sigmatifolia} in the northern North Island.
...
All have vestigial leaves and strongly jointed stems, which in \itindex{Korthalsella lindsayi} and \itindex{Korthalsella clavata} are strongly flattened and in \itindex{Korthalsella salicornioides}, cylindrical. \itindex{Korthalsella salicornioides} is found throughout the country while \itindex{Korthalsella lindsayi} and \itindex{Korthalsella clavata} are found from the central North Island southwards.
...
\itindex{Peraxilla colensoi} and \itindex{Peraxilla tetrapetala} mostly parasitise \itindex{Nothofagus} species in both islands.
...
They often appear polished, with flecks of white and brown which give a resemblance to wood grain. \itindex{Gastrodia cunninghamii} and \itindex{Gastrodia minor} are found throughout, \itindex{Gastrodia cunninghamii}, mostly in beech forest, and \itindex{Gastrodia minor} mostly under \itindex{Leptospermum}. \itindex{Gastrodia sesamoides} has not been discovered further south than 42°S in the South Island and is found in open forest and shrubland.
...
Hinau (\itindex{Elaeocarpus dentatus}) reaches the central South Island, while its higher altitude relative pokaka (\itindex{Elaeocarpus hookerianus}) reaches Stewart Island.
...
Accompanying species may be the two common larger-leaved coprosmas both known as karamu: \itindex{Coprosma robusta} and \itindex{Coprosma lucida}, the bubbly-leaved ramarama (\itindex{Lophomyrtus bullata}), wharangi (\itindex{Melicope ternata}), the `tree daisies' heketara (\itindex{Olearia rani}) and the familiar large-leaved rangiora (\itindex{Brachyglottis repanda}).

Among the undershrubs which occur at higher altitudes in the north are mountain horopito (\itindex{Pseudowintera colorata}), often with an extremely attractive red or yellow leaf colouration; mountain five-finger (\itindex{Pseudopanax colensoi}) \itindex{Pseudopanax simplex}, the tree fern \itindex{Cyathea smithii} and \itindex{Coprosma foetidissima}.
...
The famous crepe fern (\itindex{Leptopteris superba}) favours moist, shady, cool situations and owes its attractively fluffy leaf texture to the ultimate leaf segments, which are set at right angles to the plane of the leaf\figureref{\fullref{fig:62crepefern}}.
...
Within this association, broader-leaved shrubs and small trees establish, including five-finger (\itindex{Pseudopanax arboreus}), lancewood (\itindex{Pseudopanax crassifolius}) \itindex{Coprosma lucida}, \itindex{Pittosporum tenuifolium}, juvenile rewa rewa (\itindex{Knightia excelsa}), juvenile kamahi (\itindex{Weinmannia racemosa}), and in moister places the tree ferns mamaku (\itindex{Cyathea medullaris}) and ponga (\itindex{Cyathea dealbata}), mahoe (\itindex{Melicytus ramiflorus}), wineberry (\itindex{Aristotelia serrata}), tree fuchsia (\itindex{Fuchsia excorticata}) and pate (\itindex{Schefflera digitata}).
...
In the North Island, and northern parts of the South Island, pukatea (\itindex{Laurelia novae-zelandiae}) is a common associate of kahikatea and in this type of forest often has well-developed plank buttresses which extend into roots raised above the forest floor with shield-like pneumatophores here and there.
...
New Zealand: F, \itindex{Nothofagus fusca} (red beech); G, \itindex{Nothofagus truncata} (hard beech); H, \itindex{Nothofagus solandri var.\ cliffortioides} (mountain beech); I, \itindex{Nothofagus menziesii} (silver beech); J, \itindex{Nothofagus s.\ var.\ solandri} (black beech).
	Photo: M. D. King.}%
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[Interior of red beech and silver beech forest]{Interior of red beech (\itindex{Nothofagus fusca}) and silver beech (\itindex{Nothofagus menziesii}) forest near the Maruia Saddle, South Island.
	Photo: J. H. Johns.}%
	\label{fig:72beech}
\end{SCfigure}
...
Among the scattered shrubs which may be present, the small leaved \itindex{Styphelia (Cyathodes) fasciculata}, \itindex{Styphelia juniperina} (soft and prickly mingi-mingi respectively), \itindex{Coprosma rhamnoides} and \itindex{Coprosma microcarpa} are most frequently encountered.
...
\begin{SCfigure}[1.0][htp]
	...
	Other New Zealand species of \itindex{Pseudopanax}, such as five-finger (\itindex{Pseudopanax arboreus}) at top right and \itindex{Pseudopanax laetum}, have large, palmatelycompound leaves with leaflets up to 25 cm long. Photo:  J. W. Dawson.}%
...
Cockayne\footnote{\cite{cockayne1899enquiry}} says: `The various forms assumed by the (juvenile) leaves of \itindex{Aristotelia fruticosa} are almost beyond belief'.
...
\begin{SCfigure}[1.0][htp]
	...
	Like kaikomako, \itindex{Pennantia baylisiana} is dioecious and the sole tree is a female.
...
\begin{SCfigure}[1.0][htp]
	...
	This hybrid was originally described as a species --- \itindex{Coprosma cunninghamii}.
...
With regard to \itindex{Sophora}, Cockayne held a view in conflict with his own theory but in accord with that of Wardle: the divaricate shrub \itindex{Sophora prostrata} is interpreted as a flowering and fruiting fixed juvenile of \itindex{Sophora microphylla}.
Godley questions this view,\footnote{\cite{godley1979leonard}} pointing out that the leaves and stems of \itindex{Sophora prostrata} and the divaricate juvenile of \itindex{Sophora microphylla} are quite dissimilar, as are the flowers and seed pods of the two species.
He proposes an interesting and quite different explanation --- the extremely variable \itindex{Sophora microphylla} (with everything from non-divaricate to strongly divaricate juveniles depending on locality) may derive from an ancient hybridisation between the non-divaricate and relatively largeleaved small tree \itindex{Sophora tetraptera} and the dwarf divaricate shrub \itindex{Sophora prostrata}.
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[Short tussock grassland dominated by fescue-tussock]{Short tussock grassland dominated by fescue-tussock (\itindex{Festuca novae-zelandiae}) on the Mt.
...
Two leafless brooms, \itindex{Carmichaelia petriei} and \itindex{Carmichaelia robusta}, with slender switch-like branches, may stand above the tussocks in drier sites, while among smaller shrubs are \itindex{Pimelea oreophila} and \itindex{Styphelia nesophila} (= \itindex{Cyathodes fraseri}).
Notable among the larger herbs is the spaniard\footnote{Also known as speargrass.} \itindex{Aciphylla subflabellata}, whose close rosettes of much-divided leaves look like clusters of grey, slender, sharply-pointed knitting needles\figureref{\fullref{fig:84aciphylla}} and whose equally spiny bracts form cage-like enclosures for the seeds\figureref{\fullref{fig:85aciphylla-seedhead}}.
The golden spaniard (\itindex{Aciphylla aurea}) also often descends into short tussock grassland from higher altitudes.
...
First come species of \itindex{Epilobium} (\itindex{Epilobium brunnescens}, \itindex{Epilobium melanocaulon} and \itindex{Epilobium microphyllum}) and flat circular patches, up to a metre in diameter, of \itindex{Raoulia tenuicaulis}.
As wind-blown silt accumulates, \itindex{Raoulia hookeri}, \itindex{Raoulia australis} and other epilobiums follow and, if stable conditions continue, taller plants appear: short tussock grasses, carmichaelias, hebes, parahebes, matagouri (\itindex{Discaria toumatou}) and others.\footnote{\cite{calder1961plant}}
...
The species concerned are not confined to such sites, but some are most frequent there, including ribbonwood (\itindex{Plagianthus regius}), and species of lacebark (\itindex{Hoheria}) of the family Malvaceae and perhaps most notably the small trees that bear New Zealand's best known flower, the kowhais (\itindex{Sophora}).  \itindex{Sophora microphylla} is found throughout and \itindex{Sophora tetraptera}, with larger leaflets, in the eastern North Island.
...
Among shrubs several willow-leaved koromikos (\itindex{Hebe}) are prominent, for example \itindex{Hebe salicifolia} and varieties of \itindex{Hebe stricta}, as well as several species of the related \itindex{Parahebe} of which one is appropriately named \itindex{Parahebe catarractae}.
...
Other wider ranging shrubs are the dwarf kowhai (\itindex{Sophora prostrata}), the leafless \itindex{Clematis} (\itindex{Clematis afoliata}), the densely twiggy \itindex{Corokia cotoneaster} and other small, drought-resistant shrubs.
...
Other forms of \itindex{Anisotome lyallii} occur in Fiordland and Stewart Island.
...
On the terraces behind the beaches and on shingle fans there may be a close cover of densely twiggy, small-leaved shrubs belonging to several genera --- \itindex{Coprosma propinqua}, \itindex{Coprosma rigida},  \itindex{Melicytus crassifolius},  \itindex{Muehlenbeckia astonii} and hummocky shrubby forms of the lianes \itindex{Muehlenbeckia complexa} and \itindex{Rubus squarrosus}.
In this situation \itindex{Rubus squarrosus} is quite leafless and beset with yellow prickles.
...
Often backing this zone is a fringe of the small-leaved twiggy shrub \itindex{Plagianthus divaricatus}, a strange relative of the much larger ribbonwood (\itindex{Plagianthus regius}) found in inland forests.
...
Dominance is shared by the mountain ribbonwood (low forest only), \itindex{Dracophyllum longifolium} (scrub only), \itindex{Dracophyllum traversii} and \itindex{Olearia lacunosa}, the last two being up to 7 m tall.
...
At higher altitudes in the south-west of the South Island \itindex{Dracophyllum traversii} is replaced by the smaller \itindex{Dracophyllum menziesii} and the equally distinctive \itindex{Dracophyllum fiordense}, which has an often unbranched trunk up to 2 m high topped by an almost spherical mop of strongly downwardly curved leaves\figureref{\fullref{fig:92dracophyllum}}. \itindex{Dracophyllum longifolium} is one of many shrub species with smaller needle leaves and a heath-like appearance.
...
Three of these are prostrate and scrambling, \itindex{Coprosma cheesemanii}  and \itindex{Coprosma crenulata} in damp places in tussock grassland and \itindex{Coprosma depressa}  on rocky sites. \itindex{Coprosma pseudocuneata} with its attractive, strongly recurved, yellowish green leaves has an erect habit and extends to quite high altitudes in sheltered rocky sites.
The one large-leaved \itindex{Coprosma}, \itindex{Coprosma serrulata}, grows in shaded tussock shrubland  and also on shaded rocky bluffs.
...
Two other species are more localised, \itindex{Brachyglottis adamsii} in adjacent parts of the North and South Islands, and \itindex{Brachyglottis revolutus} in the south-west of the South Island.
...
On the wetter western mountains of the South Island the broadleaved snow tussock (\itindex{Chionochloa flavescens}), can grow sometimes 2 m high, and dominates in the zone 200 m above treeline.
The mid-ribbed snow tussock (\itindex{Chionochloa pallens}) is often present, generally on younger, better drained soils.
Both species are also common on the North Island axial ranges.
With increasing altitude on the wet South Island mountains the two large snow tussocks gradually give way to the much smaller curled snow tussock (\itindex{Chionochloa crassiuscula}).
...
On Mt. Taranaki (Egmont) and the central volcanoes in the North Island the only snow tussock present is red tussock (\itindex{Chionochloa rubra}), which occupies a wide range of habitats in the herbfield zone.
...
On the drier eastern South Island mountains in the southern half, the dominant snow tussock in the low alpine zone is the narrow-leaved snow tussock (\itindex{Chionochloa rigida}).
This gives way at higher altitudes to the smaller recently described slim snow tussock (\itindex{Chionochloa macra}).
Only slim snow tussock extends north of the central South Island and it then occupies a broader altitudinal zone.

Among the smaller species of \itindex{Chionochloa}, which are found mostly at higher levels in herbfield, carpet grass (\itindex{Chionochloa australis}) is worth a special mention.
...
Further east, but still in moist situations, the grey-green \itindex{Aciphylla scott-thomsonii} is prominent\figureref{\fullref{fig:96snow-tussock}}.
...
One of the latter, \itindex{Aciphylla colensoi}, is notable for the bright yellow to orange midribs of its leaf segments.

The golden spaniard, \itindex{Aciphylla aurea}, is often prominent in drier habitats in the eastern South Island and is characteristic of narrow-leaved snow tussock grassland\figureref{\fullref{fig:98golden-spaniard}}.
...
\begin{SCfigure}[1.0][htp]
	...
	Two mountain daisies are present, \itindex{Celmisia semicordata}  below and \itindex{Celmisia armstrongii} above.
...
Other smaller, but still large, species have bright buttercup yellow flowers, for example the variable \itindex{Ranunculus insignis} throughout the axial ranges of the North Island and in the northern half of the South Island and \itindex{Ranunculus nivicola} in the tussock herbfield of Mt.
...
The flowers are distinctively arranged in spreading circles or whorls, one above the other. \itindex{Ourisia macrophylla} with two subspecies is found on wetter mountains in the North Island and \itindex{Ourisia macrocarpa} also with two subspecies in similar sites throughout the South Island.
...
The similar \itindex{Gentiana montana} is widespread in the wetter, mostly western mountains of the South Island and in Stewart Island. \itindex{Gentiana bellidifolia}, a somewhat smaller species, ranges throughout the mountains of both North and South Islands.
...
\begin{SCfigure}[1.0][htp]
	...
	\centering
	\caption[A group of celmisias in flower]{A group of celmisias in flower --- \itindex{Celmisia semicordata}.
	There are a few non-flowering rosettes of \itindex{Celmisia traversii} also.
...
The species is common in both open shrubland and tussock herbfield on wetter mountains throughout the South Island except the far north. \itindex{Celmisia verbascifolia}, with a similar range to \itindex{Celmisia semicordata}, and \itindex{Celmisia traversii}  in the north-west and south-west of the South Island are similar in habit, but somewhat smaller than \itindex{Celmisia semicordata}. \itindex{Celmisia verbascifolia} is notable for the bright purple petioles and midribs of its leaves and \itindex{Celmisia traversii} for the deep, velvety rusty red tomentum on the leaf undersides.
The commonest \itindex{Celmisia} in New Zealand is \itindex{Celmisia spectabilis}, which in some of its forms is like a small \itindex{Celmisia semicordata}.
...
Three species are similar in having tufts of long, narrow, pointed sword-like leaves, which leads to them sometimes being mistaken for spaniards (\itindex{Aciphylla}). \itindex{Celmisia lyallii} ranges along the eastern sides of the South Island mountains in \itindex{Chionochloa macra} grassland, and \itindex{Celmisia petriei}  and \itindex{Celmisia armstrongii}  together span the wetter western mountains of the South Island, \itindex{Celmisia petriei}  in the north-west and south-west and \itindex{Celmisia armstrongii}  in between.
...
Their leaves are tufted and long and narrow. \itindex{Bulbinella hookeri} ranges from the North Island mountains to north Canterbury; \itindex{Bulbinella angustifolia}, sometimes inappropriately known as `Maori onion', ranges through the drier eastern mountains of the South Island from North Canterbury southwards; and \itindex{Bulbinella gibbsii} in the wetter mountains of the southern North Island, southern South Island and Stewart Island.
...
They are not of the whipcord type, but have small rounded leaves arranged in attractive patterns. \itindex{Hebe haastii} and \itindex{Hebe epacridea}\figureref{\fullref{fig:106hebe}} are yellow or orangey-green; \itindex{Hebe petriei} is grey-green.
...
Notable among larger herbs are the grey-green, hairy \itindex{Ranunculus buchananii} with large, white flowers and the yellow-green \itindex{Ranunculus grahamii} with large yellow flowers.
...
Two spaniards (\itindex{Aciphylla}) are notable cushion plants in fellfield. \itindex{Aciphylla dobsonii} in South Canterbury and North Otago may form perfectly hemispherical cushions more than half a metre in diameter\figureref{\fullref{fig:110cushion-spaniard}}, while \itindex{Aciphylla simplex} of Central Otago forms somewhat smaller cushions.
...
This is the case for two species of \itindex{Caltha} with their Ranunculus-like flowers, those of \itindex{Caltha obtusa}  being white and \itindex{Caltha novae-zelandiae} yellow.
Snowbank plants form a continuous sward, with the snow patch grass, \itindex{Chionochloa oreophila}, usually predominating.
Among other prominent plants are \itindex{Ranunculus sericophyllus} with deeply divided leaves and relatively large yellow flowers; \itindex{Celmisia allanii}, with patch forming rosettes of fluffy pale grey to snow white leaves; the related but pale green \itindex{Celmisia haastii}, and two mat forming species, which although flowering plants look remarkably like mosses --- \itindex{Raoulia subulata} and \itindex{Drapetes lyallii}.
...
Of these, \itindex{Nothofagus} (\itindex{Nothofagus menziesii} --- silver beech) is a forest dominant, \itindex{Stilbocarpa} is a tall herb of far southern coasts, while the remainder are low growing plants ascending to subalpine or alpine levels, eight of them being more or less cushion or mat-forming'.
...
In eastern Australia there are two species assignable to \itindex{Aciphylla}, one to \itindex{Anisotome} and three to \itindex{Gingidia}, including a localised occurrence of \itindex{Gingidia montana}.
...
Two of these in southern South America are shared with New Zealand (\itindex{Hebe elliptica}, \itindex{Hebe salicifolia}) and the third is \itindex{Hebe rapensis} on Rapa Island in French Polynesia.
...
In \itindex{Pleurophyllum hookeri} the flower heads, coloured reddish purple, are relatively small as their `petals' are greatly reduced.
...
Two species of \itindex{Pleurophyllum} are conspicuous --- \itindex{Pleurophyllum speciosum} (Fig 117) with rosettes of almost circular, pale green longitudinally pleated leaves up to 30 cm in diameter and \itindex{Pleurophyllum criniferum} with even longer, but ascending, leaves up to 1 m long.
...
Instead up to about 200 m altitude in sheltered places there is a dense shrubland comprising the endemic \itindex{Dracophyllum scoparium} and \itindex{Dracophyllum longifolium}.
...
There are no conifers at all, no beeches (\itindex{Nothofagus}), nor any of the other canopy dominants such as tawa (\itindex{Beilschmiedia tawa}), kamahi (\itindex{Weinmannia racemosa}), hinau (\itindex{Elaeocarpus dentatus}), or northern or southern rata (\itindex{Metrosideros robusta}, \itindex{Metrosideros umbellata}).
...
The tree ferns \itindex{Dicksonia squarrosa} and \itindex{Dicksonia fibrosa} are prominent in the understory and filmy ferns on the forest floor and, as epiphytes, are a prominent feature.
...
Among these, certain large herbs once formed a band of lush vegetation at the top of many sandy and stony storm beaches: the nettle \itindex{Urtica australis}, \itindex{Embergeria (Sonchus) grandifolius} and \itindex{Myosotidium hortensia}. \itindex{Myosotidium hortensia}, now widely cultivated, could be called a giant forget-me-not.
...
Endemics of sea cliffs include \itindex{Hebe chathamica}, \itindex{Hebe dieffenbachii} and the grasses \itindex{Poa chathamica} and \itindex{Festuca coxii}. \itindex{Myosotidium hortensia} may still be found in inaccessible places.
Dense shrubberies of \itindex{Olearia chathamica} may be prominent along cliff tops.
A large, grey-green, remarkably soft-leaved \itindex{Aciphylla}, \itindex{Aciphylla dieffenbachii}, was formerly common along the southern cliffs of the main island and is still frequent on Pitt Island.
A smaller species, \itindex{Aciphylla traversii}, is a plant of tableland bogs, but it, too, has been reduced by stock.
...
Karakas (\itindex{Corynocarpus laevigatus}) and ngaios (\itindex{Myoporum obscurum}, closely related to \itindex{Myoporum laetum}) also reach 20 m in height in sheltered places; considerably greater dimensions than they usually attain in New Zealand.
...
Eighteen species and three varieties are considered to be endemic and those with New Zealand affinities are \itindex{Coprosma petiolata} and \itindex{Coprosma acutifolia}, the tree ferns \itindex{Cyathea milnei} and \itindex{Cyathea kermadecensis},  \itindex{Pseudopanax arboreus var.\ kermadecensis} (close to the New Zealand variety and like it sometimes a tree fern epiphyte), \itindex{Metrosideros kermadecensis}, (known as the Kermadec pohutukawa in cultivation in New Zealand; it has shorter, more rounded leaves than pohutukawa (\itindex{Metrosideros excelsa})), \itindex{Myoporum obscurum}, \itindex{Hebe breviracemosa} (now probably extinct) and the palm \itindex{Rhopalostylis baueri var.\ cheesemanii}.
...
Vascular epiphytes also are more numerous --- species of the orchid genera \itindex{Dendrobium} and \itindex{Bulbophyllum}, and species of \itindex{Peperomia} and among ferns \itindex{Asplenium australasicum}, \itindex{Asplenium polyodon}, \itindex{Pyrrosia confluens} and the fern ally \itindex{Tmesipteris forsteri}.

The cliffs are occupied mostly by species widespread in the south-west Pacific, with the exception of \itindex{Phormium tenax}, shared with New Zealand, and \itindex{Coprosma baueri}, which occupies similar sites to its very close relatives \itindex{Coprosma repens} in New Zealand and \itindex{Coprosma petiolata} in the Kermadecs.
...
Conspicuous are some of the handsome palms for which Lord Howe is noted --- \itindex{Howea forsteriana} and \itindex{Howea belmoreana} at lower elevations with \itindex{Hedescepe canterburyana} higher up.
...
In eastern Victoria and Tasmania the species involved, \itindex{Nothofagus cunninghamii}, is closely related to \itindex{Nothofagus menziesii} of New Zealand. \itindex{Nothofagus moorei} of montane sites in north central New South Wales and near the New South Wales, Queensland border also belongs to the `\itindex{Nothofagus menziesii} group', but has larger leaves than either \itindex{Nothofagus cunninghamii} or \itindex{Nothofagus menziesii}.
...
One of these, \itindex{Eucalyptus regnans}, is the tallest flowering plant in the world, attaining a height of 100 m or more.
...
Generally inland from the eucalyptus-dominated communities, where climates are drier and soils infertile, drought-resistant species of \itindex{Acacia}, particularly \itindex{Acacia aneura} (mulga), prevail.
...
In Tasmania there are, in addition, thickets of a shrubby deciduous species of \itindex{Nothofagus}, \itindex{Nothofagus gunnii}, which belongs to the \itindex{Nothofagus fusca} group.
...
In places dense stands of \itindex{Araucaria cunninghamii} and \itindex{Araucaria hunsteinii} are emergent over lower montane forest species.
...
Species of \itindex{Nothofagus} of the `\itindex{Nothofagus brasii} group' are an important component in these forests, particularly on ridge crests where pure or nearly pure stands of \itindex{Nothofagus} occur.
...
The species of \itindex{Nothofagus}, as in New Guinea, belong to the \itindex{Nothofagus brasii} group and some are notable for having unusually large leaves particularly at the juvenile stage\figureref{\fullref{fig:70nothofagus}}.
...
There are 10 species of \itindex{Nothofagus} altogether, 2 belonging to the \itindex{Nothofagus menziesii} group and 8 to the \itindex{Nothofagus fusca} group.
Seven species are deciduous (both of the \itindex{Nothofagus menziesii} group species and 5 of the \itindex{Nothofagus fusca} group), generally in response to seasonal drought or cold.

Above the lowland forest on the seaward slopes of the coastal range there is first a zone of evergreen \itindex{Nothofagus} involving two species in succession, then below treeline the deciduous \itindex{Nothofagus antarctica}.
This is similar to the \itindex{Nothofagus cunninghamii}/\itindex{Nothofagus gunnii} pattern in Tasmania.
...
The two deciduous species of the \itindex{Nothofagus menziesii} group, unlike \itindex{Nothofagus menziesii} itself, are tolerant of some seasonal drought and used to form forests in the central valley from 38 to 41 °S and further north at higher altitudes on the coastal range. \itindex{Sophora microphylla} and species of \itindex{Aristotelia} and \itindex{Muehlenbeckia} are sometimes associated with these species of \itindex{Nothofagus}.
...
Only three species of \itindex{Nothofagus} are present in these latitudes --- the evergreen \itindex{Nothofagus betuloides} and the deciduous \itindex{Nothofagus pumilio} and \itindex{Nothofagus antarctica}.

From about 52 to 55°S the sequence from west to east is: an open moorland with little forest; evergreen \itindex{Nothofagus betuloides}; deciduous \itindex{Nothofagus pumilio} and \itindex{Nothofagus antarctica}; and short tussock grassland on the eastern plains.
...
Genera shared with New Zealand are \itindex{Oreobolus}, \itindex{Gaimardia}, \itindex{Phyllachne}, \itindex{Donatia}, \itindex{Astelia}, \itindex{Drosera} and \itindex{Lepidothamnus}. \itindex{Lepidothamnus fonckii} has a very similar growth habit to the pygmy pine (\itindex{Lepidothamnus laxifolius}) of New Zealand.
...
From the middle Eocene the climate cooled, a number of the tropical genera disappeared from southern Australia, and pollen of \itindex{Nothofagus brassii} group increased in importance.
...
The forests were dominated by the \itindex{Nothofagus brassi} group, although the \itindex{Nothofagus fusca} group, \itindex{Casuarina}, \itindex{Myrtaceae}, \itindex{Palmae} and \itindex{Podocarpaceae} were also prominent.
